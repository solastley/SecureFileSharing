...
public class EncryptionThread extends ServerThread
{
	private final Socket socket;
	private final EncryptionServer server;

	public EncryptionThread(Socket _socket, EncryptionServer _server)
	{
		socket = _socket;
		server = _server;
