...
public interface GroupClientInterface
{
  ...
  *
  */
  public boolean connect(final String server, final int port, boolean isFileServer);
  ...
  * @param password The password for the user whose token is being requested
  *
  * @return A UserToken describing the permissions of "username."
  *         If this user does not exist, a null value will be returned.
  *
  */
  public UserToken getToken(final String username, final String password, final String fs_ip, final int fs_port);
